 ...
 * @tparam Object: type of vectors elements generated by strategy.
 */
...
class Builder : public CloneHelper<Object, Builder<Object, Value...>> {
 ...
 private:
  ...
  /**
   * Helper function for ``strategies_`` tuple unpacking
  ...
  /**
   * Helper function for producing values from variadic strategies.
   */
  Object produce(
